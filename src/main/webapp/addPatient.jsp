                ...
                <section>
					...
					<p>Enter patient detail</p>
							<div class="form-row">
								...
								<div class="form-holder">
									<br>Age : <br>
									<input type="number" min = "0.00" step = "0.01" value = "0.00" name="patientage" placeholder="Age" class="form-control">
								</div>
								<div class="form-holder">
									<br>Email : <br>
									<input type="text" name="patientemail" placeholder="Email" class="form-control">
								</div>
								<div class="form-holder">
									<br>Race : <br>
								...
								<div class="form-holder">
									<br>Phone number : <br>
									<input type="text" name="patientphonenum" placeholder="PhoneNum" class="form-control">
								</div>
								<div class="form-holder">
									<br>Password : <br>
